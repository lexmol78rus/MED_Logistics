...
### Актуальный бекап за 2026-05-28 (контрольная точка «2»)

- **Архив кода на сервере**: `/home/adminmed/backups/2026-05-28/2_MED_Logistics_2026-05-28_20260528T174122Z.tar.gz`
- **Дамп БД (копия в репозитории)**: `backup/2_med_warehouse_prod_2026-05-28_20260528T174122Z.sql.gz`
- **Git ветка бекапа**: `backup/2-2026-05-28`

Предыдущий снимок того же дня (без префикса «2»): `backup/2026-05-28`, `med_warehouse_prod_2026-05-28_104456.sql.gz`.
